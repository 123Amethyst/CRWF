...
namespace CRDT.WF.Infrastructure
{
    public class TypeHelper
    {
        ...
        public static object GetDataByType(object data1, Type itype, params object[] myparams)
        {
            ...
            try
            {
                if (itype == typeof(decimal) || itype == typeof(decimal?))
                {
                ...
                else if (itype == typeof(double) || itype == typeof(double?))
                {
                ...
                else if (itype == typeof(Int32) || itype == typeof(Int32?))
                {
                    result = Convert.ToInt32(data1);
                }
                else if (itype == typeof(Int64) || itype == typeof(Int64?))
                {
                    result = Convert.ToInt64(data1);
                }
                ...
                else if (itype == typeof(char) || itype == typeof(char?))
                {
                    result = Convert.ToChar(data1);
                }
