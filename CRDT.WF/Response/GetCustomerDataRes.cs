...
{
    public class GetCustomerDataRes
    {
        public List<ET_CUST_ITEM> ET_CUST_ITEM { get; set; }
        public List<ET_MESSAGE> ET_MESSAGE { get; set; }
    }
    public class ET_CUST_ITEM
    {
            /// <summary>
            /// Reference BP no.
            /// </summary>
...
public class ET_MESSAGE 
    {
        ...
        /// <summary>
        /// SAP處理狀態(S:processing successfully E:failed)
        /// </summary>
