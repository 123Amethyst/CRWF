sap.ui.define([
	...
	'sap/ui/model/json/JSONModel'
		...
		let _i18n,
			_currentUser,
			_backgroundData;
	return BaseController.extend('crdt.wf.ui5.controller.Information.FormOpenCRDTAR', {
		//初始化
		onInit: function () {
			this.initLanguage()
		...
		DataLoad: function () {
			...
			var oData = {
				CusStatusModel: jsonCusStatusDicModel, CustomerTypeModel: jsonCusTypeDicModel,
				CreditTermModel: jsonCreditTermDicModel, StatePrintModel: jsonStatePrintDicModel,
				SumInvoicePrintTimeModel: jsonInvoicePrintTimeDicModel, RiskClassModel: jsonRiskClassDicModel,
				CheckRuleModel: jsonCheckRuleReBulidModel, CreditManagerModel: jsonCreditManagerDicModel,
